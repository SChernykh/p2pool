...
void p2pool_usage()
{
	printf("P2Pool %s\n"
		"\nUsage:\n\n" \
		"--wallet                  Main wallet address (the one that starts with 4...)\n"
		...
		"--in-peers-localhost N    Maximum number of incoming localhost connections for p2p server (any value between 10 and 450)\n"
